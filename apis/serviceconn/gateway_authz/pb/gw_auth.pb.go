...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x80, 0x03, 0x0a, 0x0b,
	...
	0x74, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x73, 0x22, 0x00, 0x42, 0x25,
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_depIdxs = []int32{
	...
	1,  // 6: auth_svc.AuthService.RegisterUser:input_type -> auth_svc.RegisterUserRequest
	4,  // 7: auth_svc.AuthService.Validate:input_type -> auth_svc.ValidateRequest
	6,  // 8: auth_svc.AuthService.Login:input_type -> auth_svc.LoginUserRequest
	8,  // 9: auth_svc.AuthService.ForgotPassword:input_type -> auth_svc.ForgotPasswordReq
	10, // 10: auth_svc.AuthService.ResetPassword:input_type -> auth_svc.ResetPasswordReq
	2,  // 11: auth_svc.AuthService.RegisterUser:output_type -> auth_svc.RegisterUserResponse
	5,  // 12: auth_svc.AuthService.Validate:output_type -> auth_svc.ValidateResponse
	7,  // 13: auth_svc.AuthService.Login:output_type -> auth_svc.LoginUserResponse
	9,  // 14: auth_svc.AuthService.ForgotPassword:output_type -> auth_svc.ForgotPasswordRes
	11, // 15: auth_svc.AuthService.ResetPassword:output_type -> auth_svc.ResetPasswordRes
