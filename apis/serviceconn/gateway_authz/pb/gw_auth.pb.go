...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xb5, 0x02, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65,
	...
	0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x73, 0x22, 0x00, 0x42, 0x25, 0x5a,
	0x23, 0x2e, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x63,
	0x6f, 0x6e, 0x6e, 0x2f, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x5f, 0x61, 0x75, 0x74, 0x68,
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_depIdxs = []int32{
	...
	1, // 5: auth_svc.AuthService.RegisterUser:input_type -> auth_svc.RegisterUserRequest
	4, // 6: auth_svc.AuthService.Validate:input_type -> auth_svc.ValidateRequest
	6, // 7: auth_svc.AuthService.Login:input_type -> auth_svc.LoginUserRequest
	8, // 8: auth_svc.AuthService.ForgotPassword:input_type -> auth_svc.ForgotPasswordReq
	2, // 9: auth_svc.AuthService.RegisterUser:output_type -> auth_svc.RegisterUserResponse
	5, // 10: auth_svc.AuthService.Validate:output_type -> auth_svc.ValidateResponse
	7, // 11: auth_svc.AuthService.Login:output_type -> auth_svc.LoginUserResponse
	9, // 12: auth_svc.AuthService.ForgotPassword:output_type -> auth_svc.ForgotPasswordRes
