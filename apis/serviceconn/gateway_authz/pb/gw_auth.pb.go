...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x72, 0x32, 0xb4, 0x06, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x42, 0x0a, 0x05, 0x4c, 0x6f, 0x67,
	...
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x73, 0x22, 0x00, 0x42, 0x25, 0x5a, 0x23, 0x2e, 0x2f,
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_depIdxs = []int32{
	...
	1,  // 11: auth_svc.AuthService.RegisterUser:input_type -> auth_svc.RegisterUserRequest
	4,  // 12: auth_svc.AuthService.Validate:input_type -> auth_svc.ValidateRequest
	6,  // 13: auth_svc.AuthService.Login:input_type -> auth_svc.LoginUserRequest
	8,  // 14: auth_svc.AuthService.ForgotPassword:input_type -> auth_svc.ForgotPasswordReq
	10, // 15: auth_svc.AuthService.ResetPassword:input_type -> auth_svc.ResetPasswordReq
	12, // 16: auth_svc.AuthService.UpdatePassword:input_type -> auth_svc.UpdatePasswordReq
	14, // 17: auth_svc.AuthService.RequestForEmailVerification:input_type -> auth_svc.EmailVerificationReq
	16, // 18: auth_svc.AuthService.VerifyEmail:input_type -> auth_svc.VerifyEmailReq
	18, // 19: auth_svc.AuthService.UpdateUsername:input_type -> auth_svc.UpdateUsernameReq
	20, // 20: auth_svc.AuthService.UpdatePasswordWithPassword:input_type -> auth_svc.UpdatePasswordWithPasswordReq
	2,  // 21: auth_svc.AuthService.RegisterUser:output_type -> auth_svc.RegisterUserResponse
	5,  // 22: auth_svc.AuthService.Validate:output_type -> auth_svc.ValidateResponse
	7,  // 23: auth_svc.AuthService.Login:output_type -> auth_svc.LoginUserResponse
	9,  // 24: auth_svc.AuthService.ForgotPassword:output_type -> auth_svc.ForgotPasswordRes
	11, // 25: auth_svc.AuthService.ResetPassword:output_type -> auth_svc.ResetPasswordRes
	13, // 26: auth_svc.AuthService.UpdatePassword:output_type -> auth_svc.UpdatePasswordRes
	15, // 27: auth_svc.AuthService.RequestForEmailVerification:output_type -> auth_svc.EmailVerificationRes
	17, // 28: auth_svc.AuthService.VerifyEmail:output_type -> auth_svc.VerifyEmailRes
	19, // 29: auth_svc.AuthService.UpdateUsername:output_type -> auth_svc.UpdateUsernameRes
	21, // 30: auth_svc.AuthService.UpdatePasswordWithPassword:output_type -> auth_svc.UpdatePasswordWithPasswordRes
