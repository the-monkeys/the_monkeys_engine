...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_rawDesc = []byte{
	...
	0x73, 0x61, 0x67, 0x65, 0x32, 0x5e, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x53, 0x65, 0x72, 0x76,
	...
	0x73, 0x65, 0x22, 0x00, 0x42, 0x25, 0x5a, 0x23, 0x2e, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x73,
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_depIdxs = []int32{
	...
	1, // 2: auth_svc.AuthService.RegisterUser:input_type -> auth_svc.RegisterUserRequest
	2, // 3: auth_svc.AuthService.RegisterUser:output_type -> auth_svc.RegisterUserResponse
