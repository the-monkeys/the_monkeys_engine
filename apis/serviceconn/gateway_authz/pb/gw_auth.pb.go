...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_rawDesc = []byte{
	...
	0x63, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xe7,
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_depIdxs = []int32{
	...
	1, // 4: auth_svc.AuthService.RegisterUser:input_type -> auth_svc.RegisterUserRequest
	4, // 5: auth_svc.AuthService.Validate:input_type -> auth_svc.ValidateRequest
	6, // 6: auth_svc.AuthService.Login:input_type -> auth_svc.LoginUserRequest
	2, // 7: auth_svc.AuthService.RegisterUser:output_type -> auth_svc.RegisterUserResponse
	5, // 8: auth_svc.AuthService.Validate:output_type -> auth_svc.ValidateResponse
	7, // 9: auth_svc.AuthService.Login:output_type -> auth_svc.LoginUserResponse
