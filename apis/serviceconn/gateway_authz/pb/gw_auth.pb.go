...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_rawDesc = []byte{
	...
	0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xa3, 0x01,
	...
	0x65, 0x22, 0x00, 0x42, 0x25, 0x5a, 0x23, 0x2e, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x73, 0x65,
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_apis_serviceconn_gateway_authz_pb_gw_auth_proto_depIdxs = []int32{
	...
	1, // 3: auth_svc.AuthService.RegisterUser:input_type -> auth_svc.RegisterUserRequest
	4, // 4: auth_svc.AuthService.Validate:input_type -> auth_svc.ValidateRequest
	2, // 5: auth_svc.AuthService.RegisterUser:output_type -> auth_svc.RegisterUserResponse
	5, // 6: auth_svc.AuthService.Validate:output_type -> auth_svc.ValidateResponse
